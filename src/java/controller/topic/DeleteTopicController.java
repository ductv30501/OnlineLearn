 ...
 * @author win
 */
@WebServlet(name = "DeleteTopicController", urlPatterns = {"/authen/manage/topic/delete"})
public class DeleteTopicController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Step 2: Get deleted id from user
        String rawId = request.getParameter("id");
        int id = Integer.parseInt(rawId);
        
        // Step 3: Delete topic by id
        tdb.deleteTopic(id);
        
        // Step 4: Send redirect to list topic page
