 ...
 * @author win
 */
@WebServlet(name = "InsertFeedbackController", urlPatterns = {"/authen/feedback/insert"})
public class InsertFeedbackController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        f.setUser(user);
        fdb.insertFB(f);
        Notification n1 = new Notification("success", "Thông báo", "Gửi phản hồi thành công", true);

        // get lasted feedback id
        int lastedId = fdb.getCurrentIdentity();
        f.setFeedbackId(lastedId);
