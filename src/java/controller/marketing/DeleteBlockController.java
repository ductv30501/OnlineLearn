 ...
 * @author ADMIN
 */
@WebServlet(name = "DeleteBlockController", urlPatterns = {"/authen/marketing/post/delete/content"})
public class DeleteBlockController extends HttpServlet {
