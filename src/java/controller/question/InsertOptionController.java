 ...
 * @author Admin
 */
@WebServlet(name = "InsertOptionController", urlPatterns = {"/authen/manage/option/insert"})
public class InsertOptionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int check =  questionDB.InsertOption(option);
        notification += check;
